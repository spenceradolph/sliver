...
var payloadDefinition = agentstructs.PayloadType{
	...
	Description:                            "This (go) payload connects to sliver to interact with a specific implant",
...
func Initialize() {
	agentstructs.AllPayloadData.Get("sliverimplantgo").AddPayloadDefinition(payloadDefinition)
	agentstructs.AllPayloadData.Get("sliverimplantgo").AddBuildFunction(build)
	agentstructs.AllPayloadData.Get("sliverimplantgo").AddIcon(filepath.Join(".", "basic_agent", "agentfunctions", "sliver.svg"))
}
